  ...
  const renderLocation = () => {
    return (
      <>
        ...
        {/* Button Bagikan Lokasi Penjemputan */}
  ...
  const renderTreatment = () => {
    return (
      <>
        ...
        {/* Text Tidak perlu memilih treatment */}
        <div
          className="text"
          style={{
            textAlign: "left",
  ...
  const renderAroma = () => {
    return (
      <>
        ...
        {/* Text Pilihan Favorit Pelanggan */}
        <div
          className="text"
          style={{
            textAlign: "left",
  ...
  const renderPickupTime = () => {
    return (
      <>
        ...
        {/* Text Khusus hari Minggu, Outlet hanya akan buka sampai jam 17.00! */}
        <div
          className="text"
          style={{
            textAlign: "left",
        ...
        {/* Text Jam Pick-Up hanya berlaku mulai jam 09.00 sampai 19.00! */}
        <div
          className="text"
          style={{
            textAlign: "left",
